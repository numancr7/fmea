...
export default function ResetPasswordPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!token) {
      toast.error("Reset token is missing. Please try again from the forgot password link.");
      return;
    }
    ...
    try {
      ...
      if (res.ok) {
        ...
        toast.error(data.message || "An error occurred while resetting your password.");
      }
    } catch (error) {
